 ...
 *
 * The Job Finder uses a lightweight generated preview so the flagship trio
 * remains visually complete without depending on an external screenshot.
 */
...
const projects: Project[] = [
  ...
  },
  {
    ...
    status: 'In Development',
    liveUrl:
      'https://alchemy-job-finder.vercel.app',
    githubUrl:
      'https://github.com/keketsoleu25/alchemy-job-finder',
  },
]
</script>
    ...
    <div class="projects-grid">
      ...
      >
        <div class="project-top">
          ...
          <span
            class="status"
            :class="project.status === 'Production' ? 'production' : 'development'"
          >
            {{ project.status }}
          </span>
        </div>
...
.project-placeholder {
  ...
  text-align: center;
  background:
    radial-gradient(circle at 50% 25%, rgba(45, 212, 191, 0.14), transparent 38%),
    linear-gradient(145deg, #081219, #05090d);
}
